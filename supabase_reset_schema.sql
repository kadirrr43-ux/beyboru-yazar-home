-- Beyboru Yazar Evi - Supabase Reset Schema
-- ESKİ TABLOLARI SİLİP YENİDEN OLUŞTURUR
-- DİKKAT: Bu script tüm verileri siler!

-- ============================================
-- 1. ESKİ POLICY'LERİ SİL
-- ============================================
...
-- ============================================
-- 4. ESKİ TABLOLARI SİL (CASCADE ile ilişkili veriler de silinir)
-- ============================================
DROP TABLE IF EXISTS books CASCADE;
DROP TABLE IF EXISTS settings CASCADE;

-- ============================================
-- 5. STORAGE BUCKET'INI SİL (varsa)
-- ============================================
DELETE FROM storage.buckets WHERE id = 'images';

-- ============================================
-- 6. YENİ TABLOLARI OLUŞTUR
-- ============================================
...
-- KURULUM TAMAMLANDI
-- ============================================
SELECT 'Schema başarıyla sıfırlandı ve yeniden oluşturuldu!' as status;
